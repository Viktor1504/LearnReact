...
test("status of specified task should be changed", () => {
  const action = updateTaskAC({ todolistId: "todolistId2", taskId: "2", model: { status: TaskStatus.New } })
...
test("title of specified task should be changed", () => {
  const action = updateTaskAC({ todolistId: "todolistId2", taskId: "2", model: { title: "coffee" } })
